...
export const IconFacebook = () => {
  return (
    <div className="group">
      <svg className="text-white group-hover:text-Red-400 cursor-pointer duration-150 ease-in" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
