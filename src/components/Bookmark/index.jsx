    ...
    <section className="p-7 pt-32 overflow-x-hidden lg:flex flex-row-reverse">
      ...
      <div className="lg:pl-22 lg:pr-10 lg:w-1/2 lg:pt-22">
        ...
        <div className="flex justify-center gap-5 w-full lg:justify-start">
          <button className="bg-Blue-600 h-14 text-Grey-50 w-1/2 rounded-lg lg:w-1/3">Get it on Chrome</button>
          <button className="bg-Grey-50 h-14 shadow-lg w-1/2 rounded-lg text-Blue-950 lg:w-1/3">Get it on Firefox</button>
        </div>
      </div>
    </section>
  )
